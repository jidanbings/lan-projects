class Localization {
    ...
    static logHelpCall() {
        console.log("帮助翻译 lan-projects: https://hosted.weblate.org/engage/lan-projects/");
    }
    ...
    static logHelpCallKey(key, attr) {
        ...
        console.warn(`Translate this string here: https://hosted.weblate.org/browse/lan-projects/lan-projects-spa/${locale}/?q=${keyComplete}`);
    }
